...
; -----	Masked rgba pixel span -----
	...
	export	asm_write_rgba_span_masked
...
; -----	Unmasked rgba pixel span -----
	...
	export	asm_write_rgba_span_unmasked
...
; -----	Masked rgb pixel span -----
	...
	export	asm_write_rgb_span_masked
...
; -----	Unmasked rgb pixel span -----
	...
	export	asm_write_rgb_span_unmasked
...
; -----	Monocolor pixel span -----
	...
	export	asm_write_monocolor_span
...
; -----	Array of monocolor pixels -----
	...
	export	asm_write_monocolor_pixels
...
; -----	Masked rgba pixel span -----
	...
	export	asm_write_rgba_span_masked2
...
loop_start_rgba_span_m2
	...
	andne	r5,r4,#&00f80000	; blue (5 bits)
	andne	r6,r4,#&0000c000	; upper green (2 bits)
	...
	andne	r6,r4,#&00003800	; lower green (3 bits)
	andne	r4,r4,#&000000f8	; red (5 bits)
...
; -----	Masked rgba pixel span (dithered, even) -----
	...
	export	asm_write_rgba_span_masked_dither_even2
...
loop_start_rgba_span_mde2
	...
	; Upper byte (blue and upper green):
	andeq	r5,r4,#&00f80000	; blue (5 bits)
	andeq	r6,r4,#&00040000	; blue (sixth bit)
	orreq	r5,r5,r6,lsl#1
	andeq	r6,r4,#&0000c000	; upper green (2 bits)
	...
	; Lower byte (lower green and red):
	andeq	r6,r4,#&00003800	; lower green (3 bits)
	andeq	r5,r4,#&00000400	; lower green (sixth bit)
	orreq	r6,r6,r5,lsl#1
	andeq	r5,r4,#&00000004	; red (sixth bit)
	andeq	r4,r4,#&000000f8	; red (5 bits)
...
; -----	Masked rgba pixel span (dithered, odd) -----
	...
	export	asm_write_rgba_span_masked_dither_odd2
...
; -----	Unmasked rgba pixel span -----
	...
	export	asm_write_rgba_span_unmasked2
...
loop_start_rgba_span_um2
	...
	; Upper byte (blue and upper green):
	and	r5,r4,#&00f80000	; blue (5 bits)
	and	r6,r4,#&0000c000	; upper green (3 bits)
	...
	; Lower byte (lower green and red):
	and	r6,r4,#&00003800	; lower green (3 bits)
	and	r4,r4,#&000000f8	; red (5 bits)
...
; -----	Unmasked rgba pixel span (dithered, even) -----
	...
	export	asm_write_rgba_span_unmasked_dither_even2
...
; -----	Unmasked rgba pixel span (dithered, odd) -----
	...
	export	asm_write_rgba_span_unmasked_dither_odd2
...
; -----	Masked rgb pixel span -----
	...
	export	asm_write_rgb_span_masked2
...
; -----	Masked rgb pixel span (dither, even) -----
	...
	export	asm_write_rgb_span_masked_dither_even2
...
loop_start_rgb_span_mde2
	...
	andeq	r5,r4,#&04	; r5 = 00000b00
	andeq	r4,r4,#&f8	; r4 = bbbbb000
	orreq	r4,r4,r5,lsl#1
	...
	andeq	r6,r4,#&04	; r6 = 0000r000
	moveq	r4,r4,lsr#5	; r4 = 000rrrrr
	orreq	r4,r4,r6,lsl#1
	andeq	r6,r5,#&01	; sixth bit of green
	andeq	r5,r5,#&0e	; r5 = 0000ggg0 (three bytes from the top of green)
	orreq	r5,r5,r6,lsl#1
...
; -----	Masked rgb pixel span (dither, odd) -----
	...
	export	asm_write_rgb_span_masked_dither_odd2
...
; -----	Unmasked rgb pixel span -----
	...
	export	asm_write_rgb_span_unmasked2
...
; -----	Unmasked rgb pixel span (dither, even) -----
	...
	export	asm_write_rgb_span_unmasked_dither_even2
...
; -----	Unmasked rgb pixel span (dither, odd) -----
	...
	export	asm_write_rgb_span_unmasked_dither_odd2
...
;	beq	next_pixel_write_rgba_pixels2
	...
	; Upper byte (blue and upper green):
	andne	r9,r8,#&00f80000	; blue (5 bits)
	andne	r10,r8,#&0000c000	; upper green (2 bits)
	...
	; Lower byte (lower green and red):
	andne	r10,r8,#&00003800	; lower green (3 bits)
	andne	r8,r8,#&000000f8	; red (5 bits)
